...
my $PLOT_LINK2="http://mvic-biotech.na.pg.com/projects/Micro_Skin_Health/SuperFresh/Bioinformatics/GeneGraph/UADeepGene/UADeepGeneRA.";
...
if(! (-e "$stat_dir/map")){system("mkdir $stat_dir/map");}
my $overlib_script_header="<DIV id=overDiv style=\"Z-INDEX: 1000; VISIBILITY: hidden; POSITION: absolute\"></DIV>
<SCRIPT language=JavaScript src=\"https://github.com/pinghu/scripts/blob/main/overlib.js\"></SCRIPT>
...
my $java_script_header="<script language=\"JavaScript\">
 ...
 <SCRIPT language=JavaScript src=\"https://github.com/pinghu/scripts/blob/main/sorttable.js\"></SCRIPT>
";
...
while (my $line = <IN>){
   ...
   my $mapname=$tmp[1];
   my $html_file="/mnt/G6_2D/db/ko/kegg_tool_2017/change/map$mapid.html";
   my $pic_file="/mnt/G6_2D/db/ko/kegg_tool_2017/change/map/map$mapid.png";
...
#################################################################
	   ...
	   if ($ff =~ /\<img src\=\"\S+\" usemap\=\"\#mapdata\"/){
	       $ff="<img src\=\"map$mapid.png\" usemap\=\"\#mapdata\" border\=0\>";
	   }
...
#################################################
       ...
       open G,  ">$stat_dir/map/map$mapid.png";
       binmode G;
       print G $im2->png;
       close G;
   }
