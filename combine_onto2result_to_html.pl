...
#################################################
	...
	write_gene_html ($tmp[7], $pagename, "$goid -- $statfilename", \%PPP, \%FFF, \%long, \%acr);
    }
    close C;
...
print OUTPUT  "</table>\n";
print OUTPUT "<table BORDER=2 CELLPADDING=2 CELLSPACING=2 WIDTH=200 class=\"sortable\" id=\"93278888\">\n";
